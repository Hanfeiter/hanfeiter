...
INSERT INTO Operators (operator_id, company_name, phone) VALUES
(1, 'Эко-Транс', '+7 (495) 111-22-33'),
(2, 'Чистый Город', '+7 (495) 444-55-66'),
(3, 'Рециклинг Сервис', '+7 (495) 777-88-99'),
(4, 'Эко-Сервис', '+7 (495) 999-00-11');

INSERT INTO Waste_Types (type_id, name, description) VALUES
(1, 'Стекло', 'Бутылки, банки и другое стекло'),
(2, 'Пластик', 'ПЭТ-бутылки, пластиковая упаковка'),
(3, 'Бумага', 'Картон, офисная бумага, газеты'),
(4, 'Металл', 'Алюминиевые банки, жесть'),
(5, 'Опасные отходы', 'Батарейки, лампы, электроника');

INSERT INTO Collection_Points (point_id, address, district) VALUES
(1, 'ул. Ленина, д. 10', 'Центральный'),
(2, 'пр. Мира, д. 25', 'Северный'),
(3, 'ул. Садовая, д. 5', 'Центральный'),
(4, 'бульвар Космонавтов, д. 15', 'Южный'),
(5, 'ул. Школьная, д. 8', 'Восточный'),
(6, 'пр. Строителей, д. 42', 'Западный');

INSERT INTO Waste_Removal_Acts (point_id, operator_id, type_id, date, weight_kg) VALUES
-- Январь 2024 - Центральный район
(1, 1, 1, '2024-01-05', 150.5),
(1, 1, 2, '2024-01-05', 230.0),
(1, 2, 3, '2024-01-12', 180.7),
(3, 3, 1, '2024-01-08', 95.3),
(3, 1, 2, '2024-01-15', 310.2),
(3, 2, 3, '2024-01-22', 120.0),

-- Январь 2024 - Северный район
(2, 3, 1, '2024-01-10', 85.0),
(2, 1, 2, '2024-01-17', 195.5),
(2, 4, 4, '2024-01-24', 45.8),

-- Январь 2024 - Южный район
(4, 1, 1, '2024-01-06', 200.1),
(4, 2, 2, '2024-01-13', 275.5),
(4, 3, 3, '2024-01-20', 165.3),
(4, 4, 4, '2024-01-27', 60.2),

-- Февраль 2024 - для демонстрации работы фильтра
(1, 1, 1, '2024-02-02', 160.0),
(1, 1, 2, '2024-02-02', 245.0),
(2, 2, 3, '2024-02-05', 190.0);
```
