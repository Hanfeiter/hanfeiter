...
## 2. Выходные документы. 1-й документ (по заданию): - 📊 Выдать отчет по общему весу вывезенных отходов каждого типа за месяц по районам города, отсортированный по убыванию веса.
![](pngFILE/select1.PNG)
![](pngFILE/select11.PNG)

## 3. Выходные документы. 2-й документ:📅 Для заданной контейнерной площадки выдать график и частоту вывоза каждого типа отходов, отсортированный по дате.
